...
plt.plot(estimations['Finish time'], pd.to_numeric(estimations["Real error"])*100, linewidth=3, color=estimationColor)
plt.xlabel("Time [min]")
...
plt.plot(respApprox['Finish time'], pd.to_numeric(respApprox["Real error"])*100, linewidth=3, color=respApproxColor)
...
plt.plot(utilizationRegression['Finish time'], pd.to_numeric(utilizationRegression["Real error"])*100, linewidth=3, color=utilizationRegressionColor)
...
plt.plot(serviceDemandLaw['Finish time'], pd.to_numeric(serviceDemandLaw["Real error"])*100, linewidth=3, color=serviceDemandLawColor)
...
plt.plot(wangKalmanFilter['Finish time'], pd.to_numeric(wangKalmanFilter["Real error"])*100, linewidth=3, color=wangKalmanFilterColor)
...
plt.plot(kumarKalmanFilter['Finish time'], pd.to_numeric(kumarKalmanFilter["Real error"])*100, linewidth=3, color=kumarKalmanFilterColor)
...
plt.plot(responsetimeRegression['Finish time'], pd.to_numeric(responsetimeRegression["Real error"])*100, linewidth=3, color=responsetimeRegressionColor)
# Legend
